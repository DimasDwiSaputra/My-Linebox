              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"action="{{url('projectku/update')}}">
                      
                      @csrf
                          <input type="hidden" id="first-name" name="id" class="form-control " value="{{ $value -> id_pegawai }}">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="date" id="last-name" name="ttl" required="required" class="form-control" value="{{$value -> ttl}}">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Alamat</label>
                        <div class="col-md-6 col-sm-6 ">
                          <input id="middle-name" class="form-control" type="text" name="alamat" value="{{$value -> alamat}}">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <div id="gender" class="btn-group" data-toggle="buttons">
                            <SELECT id="middle-name" class="form-control" type="text" name="jk" value="{{$value -> jk}}" >
                              <option>Laki-Laki</option>
                              <option>Perempuan</option>
                            </select>
                            <!-- <label class="btn btn-secondary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                              <input type="radio" name="jk" value="male" class="join-btn"> &nbsp; Pria &nbsp;
                            </label>
                            <label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                              <input type="radio" name="jk" value="female" class="join-btn"> Wanita
                            </label> -->
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align">Telepon/No HP <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input id="tlp" name="tlp" class="date-picker form-control" required="required" type="text" value="{{$value -> tlp}}">
                        </div>
                      </div>
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <div id="status" class="btn-group" data-toggle="buttons">
                            <SELECT id="middle-name" class="form-control" type="text" name="status" value="{{$value -> status}}" >
                              <option>Aktif</option>
                              <option>Cuti</option>

            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"action="{{url('projectku')}}">
                      @csrf
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="date" id="last-name" name="ttl" required="required" class="form-control">
                        </div>
                      </div>
                      <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <div id="gender" class="btn-group" data-toggle="buttons">
                            <select id="middle-name" class="form-control" type="text" name="jk">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input id="tlp" name="tlp" class="date-picker form-control" required="required" type="text">
                        </div>
                      </div>
                        <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <div id="status" class="btn-group" data-toggle="buttons">
                            <select id="middle-name" class="form-control" type="text" name="status">
                              <option>Aktif</option>
                              <option>Cuti</option>

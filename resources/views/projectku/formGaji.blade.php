            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{url('gajiku')}}">
                      @csrf
                      <div class="item form-group" >
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Nama <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="first-name" name="nama"required="required" class="form-control @error ('nama') is-invalid @enderror">
                          @error('nama')
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="date" id="first-name" name="date"required="required" class="form-control ">
                        </div>
                      </div>

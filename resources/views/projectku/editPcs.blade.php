            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    @foreach($report_pcs as $value)
                    <form method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"action="{{url('projectku/updatePcs')}}">
                      @csrf
                          <input type="hidden" id="first-name" name="id" class="form-control " value="{{ $value -> id }}">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input id="middle-name" class="form-control" type="text" name="total"  value="{{ $value -> total }}">
                        </div>
                      </div>

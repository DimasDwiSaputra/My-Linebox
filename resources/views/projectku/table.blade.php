...
@section('content')
  ...
  <div class="card-header">
    Data Karyawan  |
    <a class="btn btn-primary" style="color: white;" href="{{route('add')}}" role="button">Tambah Data Karyawan</a>
    <a href="/pegawai/cetak_pdf" class="btn btn-info" target="_blank">CETAK PDF</a>
  </div>
<div class="card-body">
 ...
 <table class="table table-stripped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a class="btn btn-warning" href="/projectku/edit/{{ $value->id_pegawai}}" role="button">Edit</a>| <a class="btn btn-danger" href="/projectku/hapus/{{ $value->id_pegawai}}" role="button">Delete</a></td>
    </tr>
  <?php }?>
  </tbody>
 </table>
